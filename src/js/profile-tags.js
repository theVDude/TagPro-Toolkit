...
mostlosses2.reverse();
if(Object.size(usertags)>24){
$('#minute-button').after('<button id="best-button">Best Users</button><button id="worst-button">Worst Users</button>');
}
$('#minute-button').after('<button id="map-button">By Map</button><button id="server-button">By Server</button>');
if(Object.size(usertags)>24){
...
for(x in bestwith){if(x<25){pmlist.innerHTML+='<tr><td class="alt">'+bestwith[x][0]+'</td><td>'+bestwith[x][1]+'</td><td class="alt">'+mostwins2[x][0]+'</td><td>'+mostwins2[x][1]+'</td><td class="alt">'+bestagainst[x][0]+'</td><td>'+bestagainst[x][1]+'</td><td class="alt">'+mostlosses2[x][0]+'</td><td>'+mostlosses2[x][1]+'</td></tr>';}}
...
for(x in bestwith){if(x<25){pmlist.innerHTML+='<tr><td class="alt">'+bestwith[x][0]+'</td><td>'+bestwith[x][1]+'</td><td class="alt">'+mostwins[x][0]+'</td><td>'+mostwins[x][1]+'</td><td class="alt">'+bestagainst[x][0]+'</td><td>'+bestagainst[x][1]+'</td><td class="alt">'+mostlosses[x][0]+'</td><td>'+mostlosses[x][1]+'</td><td class="alt">'+mostgames[x][0]+'</td><td>'+mostgames[x][1]+'</td></tr>';}}
pmlist.innerHTML+="</table>";
$('table.board:last-of-type').before(pmlist);}
